...
const ExerciseCard = ({ workout }: ExerciseCardProps) => {
  return (
    <Link href={`/DetailPage/${workout.id}`} >
      <div className="bg-[#13151b] rounded-2xl border border-zinc-800/60 overflow-hidden flex flex-col justify-between hover:border-[#ccff00] transition-all duration-200">
        
        <div className="relative w-full h-[250px] bg-zinc-900 overflow-hidden">
          <Image
            src={workout.image}
            alt={workout.name}
            fill
